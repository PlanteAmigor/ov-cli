...
public:
    ...
    // Reasoning budget (thinking suppression)
    int64_t reasoning_budget_tokens = -1;   // -1 = disabled, N = max thinking tokens before forcing </think>
    int64_t thinking_start_token_id = -1;   // token ID for <think> (e.g. 248068 for Qwen3.6)
    int64_t thinking_end_token_id = -1;     // token ID for </think> (e.g. 248069 for Qwen3.6)
